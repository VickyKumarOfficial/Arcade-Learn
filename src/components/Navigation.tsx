...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-[56px] left-0 right-0 z-50 bg-white/85 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 shadow-lg">
