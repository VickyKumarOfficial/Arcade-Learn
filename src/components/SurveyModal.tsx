  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <Card className="border-2 border-border shadow-2xl bg-card backdrop-blur-sm h-full flex flex-col">
            <CardHeader className="text-center space-y-4 bg-card rounded-t-lg flex-shrink-0">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <CardFooter className="flex justify-between bg-black/50 dark:bg-black rounded-b-lg flex-shrink-0 p-4 sm:p-6">
              <Button
                ...
                className="flex items-center gap-2 border-border text-muted-foreground hover:bg-muted text-sm sm:text-base"
              >
