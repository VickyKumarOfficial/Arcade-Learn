...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-slate-950 dark:via-purple-950 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 dark:text-gray-400 mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button variant="outline" size="lg" className="border-2 border-white/20 dark:border-white/30 hover:bg-white/10 dark:hover:bg-white/20 px-8 py-4 text-lg font-semibold rounded-xl backdrop-blur-sm text-sky-300 dark:text-sky-200">
              Explore Careers
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-400 dark:text-blue-300 mb-2">50+</div>
              <div className="text-gray-300 dark:text-gray-400">Learning Components</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-400 dark:text-purple-300 mb-2">5+</div>
              <div className="text-gray-300 dark:text-gray-400">Career Roadmaps</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-400 dark:text-green-300 mb-2">100%</div>
              <div className="text-gray-300 dark:text-gray-400">Free Resources</div>
            </div>
          </div>
        </div>
